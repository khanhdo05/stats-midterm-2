...
In this report, the dataset is filtered down to specifics detailed at [Midterm 2](https://rebelskyw.cs.grinnell.edu/wp-content/uploads/2025/03/Midterm2.html). We worked with two data files. We as researchers are interested in investigating the effect of mental health diagnosis during pregnancy on the prescription of opioids post-partum.
